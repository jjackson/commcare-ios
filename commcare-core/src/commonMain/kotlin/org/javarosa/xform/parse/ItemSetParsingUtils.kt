...
class ItemSetParsingUtils {
    companion object {
        ...
        fun setLabel(itemset: ItemsetBinding, labelXpath: String?) {
            ...
            itemset.labelRef = DataInstance.unpackReference(getAbsRef(XPathReference(labelPath), itemset.nodesetRef!!))!!
        ...
        fun setValue(itemset: ItemsetBinding, valueXpath: String?) {
            ...
            itemset.valueRef = DataInstance.unpackReference(getAbsRef(XPathReference(valuePath), itemset.nodesetRef!!))!!
        ...
        fun setSort(itemset: ItemsetBinding, sortXpathString: String?) {
            ...
            itemset.sortRef = DataInstance.unpackReference(getAbsRef(XPathReference(sortPath), itemset.nodesetRef!!))!!
        ...
        fun setNodeset(itemset: ItemsetBinding, nodesetStr: String?, elementName: String) {
            ...
            val nodesetRef = getAbsRef(XPathReference(path.getReference()), itemset.contextRef!!)
