...
open class DetailParser(parser: PlatformXmlParser) : CommCareElementParser<Detail>(parser) {
    ...
    companion object {
        ...
        /**
         * Factory for creating graph parsers. Registered at JVM initialization
         * since GraphParser depends on JVM-only libraries (graph rendering).
         */
    ...
    protected open fun getGraphParser(): org.javarosa.xml.ElementParser<out org.commcare.suite.model.DetailTemplate>? {
        return graphParserFactory?.invoke(parser)
    }
}
