 ...
 *
 * Additionally, each serializer is responsible for extending the types
...
interface IAnswerDataSerializer {
     ...
     *
     * @param element The element whose data is to be serialized
     * @return true if this can meaningfully serialize the provided
     * object. false otherwise
     */
    fun canSerialize(element: IAnswerData?): Boolean

    /**
     * Serializes the given data object into a format that can
     * be stored externally using the defined schemas
     *
     * @param data     The element whose data is to be serialized
     * @param dataType The data type
     * @return An implementation-specific representation of the
     * given object if canSerialize() would return true for that
     * object. False otherwise.
     */
    fun serializeAnswerData(data: IAnswerData?, dataType: Int): Any?
     ...
     * object. False otherwise.
     */
    fun serializeAnswerData(data: IAnswerData?): Any?
     ...
     */
    fun containsExternalData(data: IAnswerData?): Boolean?
     ...
     * answer data.
     */
    fun retrieveExternalDataPointer(data: IAnswerData?): Array<IDataPointer>?
}
