 ...
 * entirely bypassing the process of performing XPath Evaluations.
 *
 ...
 * but we may need to reach between models to match complex query lookups
 *
 * Created by ctsims on 2/6/2017.
 */
interface ModelQuerySetMatcher {
     ...
     */
    fun getQueryLookupFromPredicate(expr: XPathExpression): QuerySetLookup?
     ...
     */
    fun getQuerySetLookup(ref: TreeReference): QuerySetLookup?
}
