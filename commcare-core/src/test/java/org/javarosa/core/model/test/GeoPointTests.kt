...
class GeoPointTests {
    ...
    private lateinit var geopointEvalCtx: EvaluationContext

    @Before
    fun setUp() {
        val geopointFpi = FormParseInit("/geopoint_tests.xml")
    ...
    fun testDistanceFunctionBetweenSamePoint() {
    ...
    @Test
    @Throws(XPathSyntaxException::class)
    fun testDistanceFunctionBetweenDifferentPoints() {
    ...
    @Test
    @Throws(XPathSyntaxException::class)
    fun testDistanceFunctionBetweenEmptyPoints() {
